...
const TopNav = () => {
    return (
        <div className='flex justify-between items-center text-gray-500 py-1 border-solid border-0 border-b-[1.2px] border-gray-200'>
            <div className='text-base flex items-center'>
                <div>
                    <svg height={"28px"} width={"26px"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" xmlSpace="preserve">
