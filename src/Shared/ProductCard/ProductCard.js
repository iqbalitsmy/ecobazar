...
const ProductCard = ({ productDetail }) => {
    const { title, price, thumbnail, rating } = productDetail;
    ...
    return (
        <div className='max-h-[320px] max-w-[280px] border-solid border-gray-200 hover:border-green-600 border-[1px] rounded-md shadow-md hover:shadow-green-300 cursor-pointer'>
            ...
            >
                <div className={`absolute right-4 top-4 space-y-2 ${isHovered ? `block` : `hidden`}`}>
                    <div className='bg-gray-100 p-1 md:p-2 rounded-full opacity-75 hover:opacity-100'>
