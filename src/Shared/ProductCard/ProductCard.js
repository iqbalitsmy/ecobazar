...
const ProductCard = ({ productDetail }) => {
    ...
    return (
        <Link to={`/products/${_id}`}>
            <div className='max-h-[320px] max-w-[280px] mx-auto border-solid border-gray-200 hover:border-green-600 border-[1px] rounded-md shadow-md hover:shadow-green-300 cursor-pointer'>
