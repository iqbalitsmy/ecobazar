            ...
            <div className={`${productPage ? "px-0 py-1 lg:p-2" : "p-2"} w-full my-auto`}>
                ...
                <div className={`${productPage ? "" : "relative"}`}>
                    <div className={`flex gap-2 mt-4 ${isHovered ? `block` : `hidden`}`}>
                        <div className='p-1 lg:p-2 border-solid border-[1px] hover:border-0 border-slate-200 rounded-full hover:bg-[#00B207] fill-slate-700 hover:fill-white cursor-pointer'>
                        ...
                        <div
                            className='bg-gray-100 p-1 lg:p-2 border-solid border-[1px] hover:border-0 border-slate-200 rounded-full hover:bg-[#00B207] opacity-75 fill-slate-700 hover:fill-white cursor-pointer'
                            onClick={handleOpen}
                        >
